...
type Step = 'intro' | 'questions' | 'company' | 'results';
...
export function AssessmentContainer() {
        ...
        <div className="bg-card rounded-2xl p-8 md:p-12 card-shadow border border-border">
          ...
          <div className="space-y-4 mb-8 text-left">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-foreground">{totalQuestions} questions</p>
                <p className="text-sm text-muted-foreground">About 5 minutes to complete</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0">
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 md:py-12">
      <ProgressBar
        current={step === 'company' ? totalQuestions : currentQuestionIndex + 1}
      ...
      <div className="bg-card rounded-2xl p-6 md:p-10 card-shadow border border-border min-h-[400px] flex flex-col">
        ...
        <div className={cn(
          ...
          step === 'questions' && currentQuestionIndex === 0 ? "justify-end" : "justify-between"
        )}>
          {(step === 'company' || currentQuestionIndex > 0) && (
            <Button
              variant="outline"
